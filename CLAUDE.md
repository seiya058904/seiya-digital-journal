...
docs/
  image-rules.md — format spec for writing/reviewing archive image entries
public/
...
**Entry format spec:** `docs/image-rules.md` — the format document given to other AIs for writing/reviewing archive entries. Covers all field rules, naming conventions, and the quality checklist.
